...
export const cardVariantColors = {
  ...
  warning:
    'bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 text-orange-900 dark:text-orange-300',
  attention:
 ...
 */
export function getCalloutVariantColors(variant: keyof typeof calloutVariantColors): {
  background: string;
  text: string;
} {
 ...
 */
export function getSectionBadgeColors(variant: keyof typeof sectionBadgeColors): {
  container: string;
  icon: string;
} {
