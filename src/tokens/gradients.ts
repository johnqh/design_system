...
export const GRADIENTS = {
  ...
  backgrounds: {
    ...
    overlay:
      'bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-900/50 dark:to-purple-900/50',
  },
  ...
  text: {
    primary:
      'bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-gray-100 dark:via-blue-200 dark:to-purple-200',
    secondary:
