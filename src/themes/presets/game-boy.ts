...
export const gameBoyTheme: ThemeDefinition = {
  ...
  light: {
    ...
    primary: '120 57.7% 13.3%',
    primaryForeground: '71.4 85.2% 39.8%',
    secondary: '72.6 84% 36.7%',
    secondaryForeground: '120 57.7% 13.9%',
    muted: '72.6 84% 36.7%',
    mutedForeground: '120 34.2% 18.3%',
    accent: '120 34.2% 49.4%',
    accentForeground: '71.4 85.2% 10.9%',
    destructive: '120 57.7% 13.3%',
    destructiveForeground: '71.4 85.2% 39.8%',
    success: '120 34.2% 18.3%',
    successForeground: '71.4 85.2% 39.8%',
    warning: '120 34.2% 18.3%',
  ...
  dark: {
    ...
    foreground: '71.4 85.2% 46.5%',
    card: '120 34.2% 28.6%',
    cardForeground: '71.4 85.2% 46.5%',
    popover: '120 34.2% 28.6%',
    popoverForeground: '71.4 85.2% 46.5%',
    primary: '71.4 85.2% 59.3%',
    primaryForeground: '120 57.7% 13.9%',
    secondary: '120 34.2% 28.6%',
    secondaryForeground: '71.4 85.2% 46.5%',
    muted: '120 34.2% 28.6%',
    mutedForeground: '72.6 84% 46.9%',
    accent: '72.6 84% 20%',
    accentForeground: '120 57.7% 71%',
    destructive: '71.4 85.2% 59.3%',
    destructiveForeground: '120 57.7% 13.9%',
    success: '72.6 84% 46.9%',
    successForeground: '120 57.7% 13.9%',
    warning: '72.6 84% 46.9%',
