...
export const windows2000Theme: ThemeDefinition = {
  ...
  light: {
    ...
    muted: '210 12% 80%',
    mutedForeground: '210 10% 34.3%',
    accent: '214 74% 56.6%',
    accentForeground: '0 0% 11.8%',
    destructive: '0 70% 41.7%',
    destructiveForeground: '0 0% 100%',
    success: '130 50% 27.7%',
    successForeground: '0 0% 100%',
    warning: '42 100% 24.1%',
    warningForeground: '210 17% 84%',
    info: '214 74% 36%',
  ...
  dark: {
    ...
    primary: '214 68% 80%',
    primaryForeground: '214 13% 24%',
    secondary: '214 10% 36%',
    secondaryForeground: '210 18% 92%',
    muted: '214 10% 30%',
    mutedForeground: '210 10% 73.3%',
    accent: '214 68% 45.3%',
    accentForeground: '0 0% 100%',
    destructive: '0 62% 76.9%',
    destructiveForeground: '214 13% 24%',
    success: '130 45% 59.4%',
    successForeground: '214 13% 24%',
    warning: '42 100% 58%',
    warningForeground: '0 0% 0%',
    info: '214 68% 80%',
    infoForeground: '214 13% 24%',
    border: '214 10% 52%',
    input: '214 10% 52%',
    ring: '214 68% 52%',
    well: '214 13% 21%',
