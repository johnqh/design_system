...
export const y2kTheme: ThemeDefinition = {
  ...
  light: {
    ...
    muted: '300 30% 95%',
    mutedForeground: '270 20% 46.3%',
    accent: '198 93% 60%',
    accentForeground: '0 0% 27.3%',
    destructive: '0 84% 46.5%',
    destructiveForeground: '0 0% 100%',
    success: '150 80% 27.4%',
    successForeground: '0 0% 100%',
    warning: '45 93% 28%',
    warningForeground: '300 40% 95%',
    info: '198 93% 33.4%',
  ...
  dark: {
    ...
    destructive: '0 70% 57.8%',
    destructiveForeground: '260 60% 8%',
    success: '150 70% 40%',
    successForeground: '260 60% 8%',
    warning: '45 90% 50%',
    warningForeground: '0 0% 0%',
    info: '198 93% 60%',
    infoForeground: '260 60% 8%',
    border: '260 40% 22%',
    input: '260 40% 22%',
    ring: '330 81% 60%',
    well: '260 60% 5%',
