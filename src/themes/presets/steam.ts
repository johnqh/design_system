...
export const steamTheme: ThemeDefinition = {
  ...
  dark: {
    ...
    mutedForeground: '208.2 8.2% 66.1%',
    accent: '205.2 100% 31.7%',
    accentForeground: '208.9 77.1% 83.8%',
    destructive: '0 72.4% 64.6%',
