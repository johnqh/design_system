...
export const nordTheme: ThemeDefinition = {
  ...
  dark: {
    ...
    accent: '213.1 32% 40.6%',
    accentForeground: '217.5 26.7% 94.1%',
    destructive: '354.3 42.3% 73.5%',
