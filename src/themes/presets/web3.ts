...
export const web3Theme: ThemeDefinition = {
  ...
  light: {
    ...
    primary: '328 100% 39.1%',
    primaryForeground: '0 0% 100%',
    secondary: '240 5% 96%',
    secondaryForeground: '0 0% 13%',
    muted: '240 5% 96%',
    mutedForeground: '0 0% 42.7%',
    accent: '27 89% 54%',
    accentForeground: '0 0% 21.2%',
    destructive: '0 84% 48.2%',
    destructiveForeground: '0 0% 100%',
    success: '142 71% 30%',
    successForeground: '0 0% 100%',
    warning: '38 92% 32.1%',
    warningForeground: '210 40% 97%',
    info: '226 100% 59%',
  ...
  dark: {
    ...
    destructive: '0 62.8% 59.4%',
    destructiveForeground: '0 0% 7%',
    success: '142 71% 45%',
    successForeground: '0 0% 7%',
    warning: '38 92% 50%',
    warningForeground: '0 0% 0%',
    info: '226 100% 65.3%',
    infoForeground: '0 0% 7%',
    border: '0 0% 16%',
    input: '0 0% 16%',
    ring: '328 100% 54%',
    well: '0 0% 4%',
