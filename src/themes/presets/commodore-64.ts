...
export const commodore64Theme: ThemeDefinition = {
  ...
  light: {
    ...
    mutedForeground: '281.1 37.4% 38.2%',
    accent: '249.7 37% 53.9%',
    accentForeground: '0 0% 100%',
    destructive: '11.8 41.5% 28.8%',
    destructiveForeground: '0 0% 100%',
    success: '103 35.6% 40.8%',
    successForeground: '0 0% 100%',
    warning: '50.2 67.1% 28.6%',
  ...
  dark: {
    ...
    foreground: '246.9 53% 74.1%',
    card: '246 40.8% 38.4%',
    cardForeground: '246.9 53% 74.1%',
    popover: '246 40.8% 38.4%',
    popoverForeground: '246.9 53% 74.1%',
    primary: '249.7 37% 53.9%',
    primaryForeground: '0 0% 100%',
